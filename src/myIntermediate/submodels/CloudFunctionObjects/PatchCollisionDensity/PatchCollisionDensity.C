...
:
    ...
    // volScalarField::Boundary has no copy constructor in this version
    // (deliberately -- see GeometricBoundaryField.H); construct as a copy
    // via the internal-field-and-source-boundary-field constructor
    // instead, matching how the primary constructor above builds these
    // as detached (null internal field) boundary fields.
    collisionDensity_
    (
        volScalarField::Internal::null(),
