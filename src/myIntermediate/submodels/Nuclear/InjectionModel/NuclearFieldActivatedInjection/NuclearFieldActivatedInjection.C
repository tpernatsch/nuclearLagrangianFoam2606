...
#include "NuclearFieldActivatedInjection.H"
#include "volFields.H"
...
Foam::NuclearFieldActivatedInjection<CloudType>::NuclearFieldActivatedInjection
(
...
:
    ...
    U_
    (
        owner.db().template lookupObject<volVectorField>("U")
    ),
    diameters_(),
    sizeDistribution_
    (
...
Foam::NuclearFieldActivatedInjection<CloudType>::NuclearFieldActivatedInjection
(
    const NuclearFieldActivatedInjection<CloudType>& im
)
:
...
template<class CloudType>
void Foam::NuclearFieldActivatedInjection<CloudType>::updateMesh()
{
...
template<class CloudType>
Foam::scalar Foam::NuclearFieldActivatedInjection<CloudType>::timeEnd() const
{
    return GREAT;
}
...
template<class CloudType>
Foam::label Foam::NuclearFieldActivatedInjection<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::NuclearFieldActivatedInjection<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::NuclearFieldActivatedInjection<CloudType>::setPositionAndCell
(
    const label parcelI,
    const label,
    const scalar,
...
template<class CloudType>
void Foam::NuclearFieldActivatedInjection<CloudType>::setProperties
(
    const label parcelI,
    const label,
    const scalar,
...
)
{
    ...
    parcel.U() = U_[injectorCells_[parcelI]];
...
template<class CloudType>
bool Foam::NuclearFieldActivatedInjection<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool Foam::NuclearFieldActivatedInjection<CloudType>::validInjection
(
    const label parcelI
)
{
