...
#include "NuclearLookupTableInjection.H"


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

template<class CloudType>
Foam::NuclearLookupTableInjection<CloudType>::NuclearLookupTableInjection
(
...
Foam::NuclearLookupTableInjection<CloudType>::NuclearLookupTableInjection
(
    const NuclearLookupTableInjection<CloudType>& im
)
:
...
template<class CloudType>
void Foam::NuclearLookupTableInjection<CloudType>::updateMesh()
{
...
template<class CloudType>
Foam::scalar Foam::NuclearLookupTableInjection<CloudType>::timeEnd() const
{
...
template<class CloudType>
Foam::label Foam::NuclearLookupTableInjection<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::NuclearLookupTableInjection<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::NuclearLookupTableInjection<CloudType>::setPositionAndCell
(
    const label parcelI,
...
template<class CloudType>
void Foam::NuclearLookupTableInjection<CloudType>::setProperties
(
    const label parcelI,
    const label nParcels,
    const scalar,
...
template<class CloudType>
bool Foam::NuclearLookupTableInjection<CloudType>::fullyDescribed() const
{
    return true;
}
...
template<class CloudType>
bool Foam::NuclearLookupTableInjection<CloudType>::validInjection(const label)
{
    return true;
}
