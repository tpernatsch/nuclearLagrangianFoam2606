...
#include "PatchInjectionCustom.H"
#include "distributionModel.H"

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

template<class CloudType>
const Foam::Enum<typename Foam::PatchInjectionCustom<CloudType>::velocityType>
Foam::PatchInjectionCustom<CloudType>::velocityTypeNames_
({
...
template<class CloudType>
Foam::PatchInjectionCustom<CloudType>::PatchInjectionCustom
(
...
:
    ...
    patchInjectionCustomBase(owner.mesh(), this->coeffDict().getWord("patch")),
    ...
    currentFacei_(-1)
{
    ...
    patchInjectionCustomBase::updateMesh(owner.mesh());
...
Foam::PatchInjectionCustom<CloudType>::PatchInjectionCustom
(
    const PatchInjectionCustom<CloudType>& im
)
:
    InjectionModel<CloudType>(im),
    patchInjectionCustomBase(im),
...
template<class CloudType>
void Foam::PatchInjectionCustom<CloudType>::updateMesh()
{
    patchInjectionCustomBase::updateMesh(this->owner().mesh());
}


template<class CloudType>
Foam::scalar Foam::PatchInjectionCustom<CloudType>::timeEnd() const
{
...
template<class CloudType>
Foam::label Foam::PatchInjectionCustom<CloudType>::parcelsToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
Foam::scalar Foam::PatchInjectionCustom<CloudType>::volumeToInject
(
    const scalar time0,
    const scalar time1
)
...
template<class CloudType>
void Foam::PatchInjectionCustom<CloudType>::setPositionAndCell
(
    const label parcelI,
...
)
{
    ...
    currentFacei_ = patchInjectionCustomBase::setPositionAndCell
    (
        this->owner().mesh(),
        this->owner().rndGen(),
        position,
...
template<class CloudType>
void Foam::PatchInjectionCustom<CloudType>::setProperties
(
    const label parcelI,
    const label nParcels,
    const scalar time,
...
template<class CloudType>
bool Foam::PatchInjectionCustom<CloudType>::fullyDescribed() const
{
    return false;
}
...
template<class CloudType>
bool Foam::PatchInjectionCustom<CloudType>::validInjection(const label)
{
    return true;
}
