...
template<class CloudType>
void Foam::LocalInteractionMix<CloudType>::writeFileHeader(Ostream& os)
{
...
template<class CloudType>
Foam::LocalInteractionMix<CloudType>::LocalInteractionMix
(
...
:
    ...
    //mesh_(cloud.mesh()), //this line was added
...
Foam::LocalInteractionMix<CloudType>::LocalInteractionMix
(
    const LocalInteractionMix<CloudType>& pim
)
:
...
template<class CloudType>
Foam::volScalarField& Foam::LocalInteractionMix<CloudType>::massEscape()
{
    if (!massEscapePtr_)
    {
...
template<class CloudType>
Foam::volScalarField& Foam::LocalInteractionMix<CloudType>::massStick()
{
    if (!massStickPtr_)
    {
        const fvMesh& mesh = this->owner().mesh();
...
template<class CloudType>
void Foam::LocalInteractionMix<CloudType>::info()
{
