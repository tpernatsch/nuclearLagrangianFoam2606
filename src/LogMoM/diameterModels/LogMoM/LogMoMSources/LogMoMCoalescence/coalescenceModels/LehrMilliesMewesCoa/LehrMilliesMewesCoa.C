...
namespace coalescenceModels
{
    ...
    addToRunTimeSelectionTable(LogMoMCoalescenceModel,LehrMilliesMewes,dictionary);
}
}
...
:
    LogMoMCoalescenceModel(logmom, dict),
    uCrit_(dimensionedScalar::getOrDefault("uCrit", dict, dimVelocity, 0.08)),
    alphaMax_(dimensionedScalar::getOrDefault("alphaMax", dict, dimless, 0.6))
{}
